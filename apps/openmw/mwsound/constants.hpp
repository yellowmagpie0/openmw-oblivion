...
namespace MWSound
{
    ...
    constexpr VFS::Path::NormalizedView oblivionTitleMusic("music/special/tes4title.mp3");
    constexpr VFS::Path::NormalizedView oblivionTriumphMusic("music/special/success.mp3");
    constexpr VFS::Path::NormalizedView oblivionDeathMusic("music/special/death.mp3");
